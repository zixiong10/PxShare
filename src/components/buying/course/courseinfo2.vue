         ...
         <div class="other">
                <p style="margin:0px 10px;float:left">相关教程</p><br><br>
                    <div class="others" v-for="(i,index) in list"  :key="index"  v-show="i.kind==item.kind && i.id!==item.id" >
                        <van-image class="hehe"  width="100px" height="90px"  :src="'http://localhost:3000/images/upload/'+ i.picture " @click="$router.push({name:'courseinfo',params:{item:i,list:list}})" /><br>
...
<style scoped>
.courseinfo2 .background{
    width:100%;
    height:250px;
    background-color:rgb(41, 40, 40)
}

.courseinfo2 .background .van-image{
    box-shadow:  5px 5px 5px rgb(85, 84, 84);
  
    margin-top:30px
}

.courseinfo2 .introduce{
    margin:10px 0px 5px 0px
}
.courseinfo2 .other{
    height: 200px;
}
.courseinfo2 .other .others{
    float:left;
    padding: 5px 2px ;
    width:100px
}
.courseinfo2 .other .others .van-image{
    padding:0px 2px;
}
.courseinfo2 .buy{
    height:44px;
